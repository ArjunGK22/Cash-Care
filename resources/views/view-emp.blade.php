                ...
                <form action="{{ route('employees.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group my-2">
                            ...
                            <input type="text" class="form-control" id="aadhar" placeholder="Enter your Aadhar number" name="aadhar_no"
                                value="{{ old('aadhar_no') }}">
                            <x-error prop="aadhar_no" />
                        </div>
                        <div class="form-group my-2">
                            <label for="pan">PAN Number</label>
                            <input type="text" class="form-control" id="pan" placeholder="Enter your PAN number" name="pan_no"
                                value="{{ old('pan_no') }}">
                            <x-error prop="pan_no" />
                        </div>
                    </div>
